...
## -*- texinfo -*-
## @deftypefn {Function File} {}@var{[xx,nn]} = histh (@var{y}, [@var{x}], [@var{nBins}], [@var{color}], [@var{norm}])
...
## @end deftypefn
##
## @seealso{hist,bar,barh}

## Author: Michel D. Schmid <michaelschmid@users.sourceforge.net>

function [nn, xx] = histh (varargin)

  error(nargchk(1,4,nargin))
  
  if (nargout==2)
    [nn, xx] = __hist(varargin{:},"histh");
  elseif (nargout == 1)
    nn = __hist(varargin{:},"histh");   
  else
    __hist(varargin{:},"histh");
